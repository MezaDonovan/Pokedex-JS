...
button.onclick = () => {
    ...
    fetch(url).then((res) => {
        if (res.status != "200") {
            printPokeImage("https://4.bp.blogspot.com/-BIOXudYso1E/V7JxsxzhOoI/AAAAAAAAAoU/EakP8UZ2KyM6rjd7URikkJlK6XqJQGoUgCLcB/w1200-h630-p-k-no-nu/EP665_Pikachu_debilitado.png");
